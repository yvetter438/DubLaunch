            ...
            {loading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={i} className="overflow-hidden border border-black/10 bg-white animate-pulse">
                        ...
                        <>
                          ...
                          <div className="flex items-center justify-between gap-3 text-sm text-neutral-500 mb-4">
                            <button
                              ...
                              className={`flex shrink-0 items-center gap-1 hover:text-red-500 transition-colors ${
