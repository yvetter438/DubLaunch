      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="card p-8">
          <div className="prose max-w-none">
            ...
            <h2 className="text-2xl font-bold text-black mb-4">7. Disclaimer</h2>
            <p className="text-neutral-600 mb-6">
              The information on this website is provided on an "as is" basis. To the fullest extent 
              permitted by law, DubLaunch excludes all representations, warranties, and conditions.
            </p>

            <h2 className="text-2xl font-bold text-black mb-4">8. Limitations</h2>
            <p className="text-neutral-600 mb-6">
            ...
            <p className="text-neutral-600">
              ...
              <a href="mailto:legal@dublaunch.com" className="text-uw-purple hover:text-purple-700">
                legal@dublaunch.com
              </a>
            </p>
          </div>
