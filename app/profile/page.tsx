...
export default function MyProfilePage() {
  ...
  if (!user || !profile) {
    return (
      <div className="min-h-screen bg-white pt-28 flex items-center justify-center">
        <div className="text-center">
          <p className="text-neutral-600">Unable to load profile</p>
          <button
            onClick={() => router.push('/')}
            className="mt-4 px-4 py-2 bg-uw-purple text-white rounded-lg hover:opacity-90"
          >
            Go Home
          </button>
        </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-uw-purple text-white rounded-lg hover:opacity-90 transition-colors"
              >
              ...
              <button
                ...
                className="px-4 py-2 border border-gray-300 text-neutral-600 rounded-lg hover:bg-neutral-50 transition-colors"
              >
                Logout
              </button>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="card p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-black">Profile Info</h2>
                <button
                  onClick={() => setIsEditing(!isEditing)}
                  className="flex items-center space-x-1 text-uw-purple hover:text-purple-700"
                >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="flex items-center space-x-1 px-3 py-2 bg-uw-purple text-white rounded-lg hover:opacity-90"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1 px-3 py-2 border border-gray-300 text-neutral-600 rounded-lg hover:bg-neutral-50"
                    >
                      <X className="w-4 h-4" />
                      <span>Cancel</span>
                    </button>
          ...
          <div className="lg:col-span-2">
            <div className="card p-6">
              <h2 className="text-xl font-semibold text-black mb-6">My Launches</h2>
              ...
              {launches.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-neutral-600 mb-6">Share your first project with the UW community!</p>
                  <button
                    onClick={() => router.push('/launch')}
