      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="card p-6 text-center">
            <Clock className="w-8 h-8 text-uw-purple mx-auto mb-2" />
            <div className="text-3xl font-bold text-black mb-1">10x</div>
            <div className="text-sm text-neutral-600">Faster Page Loads</div>
          </div>
          
          <div className="card p-6 text-center">
            <Database className="w-8 h-8 text-blue-600 mx-auto mb-2" />
            <div className="text-3xl font-bold text-black mb-1">95%</div>
            <div className="text-sm text-neutral-600">Fewer DB Calls</div>
          </div>
          
          <div className="card p-6 text-center">
            <TrendingUp className="w-8 h-8 text-green-600 mx-auto mb-2" />
            <div className="text-3xl font-bold text-black mb-1">1hr</div>
            <div className="text-sm text-neutral-600">Cache Duration</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border-2 border-gray-200 rounded-xl p-6">
              ...
              <Link
                href="/discover"
                className="block w-full py-3 px-4 bg-gray-100 text-neutral-600 rounded-lg hover:bg-gray-200 transition-colors text-center font-medium"
              >
                View Old Page
              </Link>
            ...
            <div className="border-2 border-purple-200 rounded-xl p-6 bg-purple-50">
              <div className="flex items-center justify-between mb-4">
                ...
                <Zap className="w-5 h-5 text-uw-purple" />
              </div>
              ...
              <Link
                ...
                className="block w-full py-3 px-4 bg-uw-purple text-white rounded-lg hover:opacity-90 transition-colors text-center font-medium"
              >
                View Cached Page ⚡
              </Link>
        ...
        <div className="card p-8 mb-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-8 h-8 bg-purple-100 text-uw-purple rounded-full flex items-center justify-center font-bold">
                1
              </div>
              <div>
                <h3 className="font-semibold text-black mb-1">First Request</h3>
                <p className="text-neutral-600">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-black mb-1">Subsequent Requests</h3>
                <p className="text-neutral-600">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-black mb-1">Auto Revalidation</h3>
                <p className="text-neutral-600">
        ...
        <div className="card p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/discover-cached"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-uw-purple text-white rounded-lg hover:opacity-90 transition-colors font-medium"
            >
              Discover (Cached)
